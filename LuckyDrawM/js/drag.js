Vue.directive('dragx', (el, binding, vnode) => {
    ...
    el.onmouseleave = function (e) {
        el.style.cursor = '';
        var k = document.getElementById("kov");
